...
1. Verify equation locators and parameter tables for the Postnov neuron-astrocyte network.
2. Curate a lawful, source-traceable microglial model with explicit state-transition equations.
